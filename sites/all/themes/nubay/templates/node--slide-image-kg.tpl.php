...
if(!empty($node_obj->field_link_font_typeface)){
    $head_font_typeface = $node_obj->field_link_font_typeface['und'][0]['value'];
  }
    ...
    ?>
       ...
       <div class="position">
							     <div class="slide_title" style="font-size:<?php print $title_font_size; ?>; color:<?php print $head_font_color; ?>; font-family:<?php print $head_font_typeface; ?>;"><?php print render($content['field_head']); ?></div>  
												...
												<div class="link_text" style="color:<?php print $link_color; ?>; background:<?php print $link_bg_color; ?>; font-family:<?php print $link_font_typeface;"><?php print render($content['field_link_text']); ?></div>
				  	</div>
					</div>
</div>
